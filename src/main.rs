...
impl Exercise {
    ...
    fn run(&self, session_key: &str) {
        ...
        let (part_1, part_2) = match (self.year, self.day) {
            ...
            (2019, 1) => run!(y2019, day1),
            (2019, 2) => run!(y2019, day2),
            (2019, 3) => run!(y2019, day3),
            (2019, 4) => run!(y2019, day4),
            (2019, 5) => run!(y2019, day5),
            (2019, 6) => run!(y2019, day6),
            (2019, 7) => run!(y2019, day7),
            (2019, 8) => run!(y2019, day8),
            (2019, 9) => run!(y2019, day9),
            (2019, 10) => run!(y2019, day10),
            (2019, 11) => run!(y2019, day11),
            (2019, 12) => run!(y2019, day12),
            (2019, 13) => run!(y2019, day13),
            (2019, 14) => run!(y2019, day14),
            // (2019, 15) => run!(y2019, day15),
            // (2019, 16) => run!(y2019, day16),
            // (2019, 17) => run!(y2019, day17),
            // (2019, 18) => run!(y2019, day18),
            // (2019, 19) => run!(y2019, day19),
            // (2019, 20) => run!(y2019, day20),
            // (2019, 21) => run!(y2019, day21),
            // (2019, 22) => run!(y2019, day22),
            // (2019, 23) => run!(y2019, day23),
            // (2019, 24) => run!(y2019, day24),
            // (2019, 25) => run!(y2019, day25),
